...
let keywords_list = failwith "Unimplemented"

let remove_noise = failwith "Unimplemented"

let k_grams = failwith "Unimplemented"

let hash = failwith "Unimplemented"

let to_windows = failwith "Unimplemented"

let winnow = failwith "Unimplemented"
